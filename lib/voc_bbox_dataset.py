...
class VOCBboxDataset(GetterDataset):
    ...
    """
    COIN_LABEL_NAME = ('1','5','10','50','100','500')
    OSATU_LABEL_NAME = ('1000','5000','10000')

    def __init__(self, data_dir, split='train', year='2012', use_difficult=False, return_difficult=False, kind="COIN"):
        ...
        if kind=="OSATU":
            self.labels_set = VOCBboxDataset.OSATU_LABEL_NAME
        elif kind=="COIN":
            self.labels_set = VOCBboxDataset.COIN_LABEL_NAME
        else:
            print("invalid kind")
            exit()
    ...
    def _get_annotations(self, i):
        ...
        for obj in anno.findall('object'):
            ...
            label.append(self.labels_set.index(name))
